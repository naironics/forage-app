...
<#-- @ftlvariable name="currentUser" type="com.naironics.forageapp.domain.CurrentUser" -->
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
            ...
            <nav role="navigation">
                ...
                <#if !currentUser??>
                    <div class="alert alert-info">
                        <center><h3> WELCOME TO FORAGE APP HOME</h3></center>
                    </div>
                    <a class="btn alert-info btn-block" href="/login">Log in</a>
                </#if>
                <#if currentUser??>
                    <div class="alert alert-info">
                        <center><h3> WELCOME TO FORAGE APPLICATION HOME</h3></center>
                    </div>
